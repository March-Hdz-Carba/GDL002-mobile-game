...
export default class App extends Component {
  ...
  //}
    ...
    if (winner[0] == 1) {
      switch (winner [1]) {
        case 0: {Alert.alert("Jugador 1 es el Ganador!!!");
        this.initializeGame();} 
          
          break;
      
        case 1: {Alert.alert("Jugador 1 es el Ganador!!!");
        this.initializeGame();} 
          
          break;
        
        case 2: {Alert.alert("Jugador 1 es el Ganador!!!");
        this.initializeGame();} 
          
          break;

        case 3: {Alert.alert("Jugador 1 es el Ganador!!!");
        this.initializeGame();} 
          ...
          switch (winner [1]) {
            case 0: {Alert.alert("Jugador 2 es el Ganador!!!");
            this.initializeGame();} 
              
              break;
          
            case 1: {Alert.alert("Jugador 2 es el Ganador!!!");
            this.initializeGame();} 
              
              break;
            
            case 2: {Alert.alert("Jugador 2 es el Ganador!!!");
            this.initializeGame();} 
              
              break;
    
            case 3: {Alert.alert("Jugador 2 es el Ganador!!!");
            this.initializeGame();} 
